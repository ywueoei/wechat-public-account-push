  ...
  USERS: [
    {
      ...
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
         id: "oyuVB5zwp5rjDiQbgry6x_AwnAYg",
...
//       id: "oyuVB5_76raBcZXXwZ5-vbtPzRMg",
      ...
      openUrl: "http://m.7xiuxing.com/xingzuo/tianxie//today",
      // 专属节日提醒，如果你在这里填写了节日提醒，就不会执行FESTIVALS的提醒了, 和FESTIVALS的配置方法相同，可以往下查看，我这里就不重复写了
      festivals: [
        // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
        {"type": "*生日", "name": "最无敌可爱亲亲老婆", "year": "1996", "date": "09-27"},
        {"type": "节日", "name": "欢乐五一", "year": "2023", "date": "05-01"},
        //{"type": "节日", "name": "和老婆度过快乐元旦", "year": "2023", "date": "01-01"},
      ...
      customizedDateList: [
        ...
        // 结婚纪念日--一见钟情
        {"keyword": "marry_day", date: "2014-06-04"},
        // 退伍日
...
//       id: "oyuVB59blP2BksYvdIoBS-6Ek0YU",
      id: "oyuVB5_76raBcZXXwZ5-vbtPzRMg",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "cdYwn-CD-SyIFoI3F9LecuMm8Qxnhp0pQrJmGuokKTk",
      // 所在省份
      province: "陕西",
      // 所在城市
      city: "渭南",
      ...
      festivals: [
        // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
        {"type": "*生日", "name": "美丽可爱亲亲老婆", "year": "1996", "date": "09-27"},
        {"type": "节日", "name": "与猪猪老婆相拥", "year": "2020", "date": "10-01"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
      ],
      // 专属纪念日/倒数日，如果你在这里填写了纪念日/倒数日，就不会计算CUSTOMIZED_DATE_LIST的日子了, 和CUSTOMIZED_DATE_LIST的配置方法相同，可以往下查看，我这里就不重复写了
      customizedDateList: [
...
//         {"keyword": "ex_day", date: "2022-09-10"},
  ...
  CALLBACK_TEMPLATE_ID: "u4W8XxIGK76asT7u9deqDYB8GZGIHK6tdYTjiggZAGM",
